...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        self.startingGameState = startingGameState # Set pacman starting position
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        return (self.startingPosition, []) # [] is all the corners that we have been there
                                           # At the starting position, we have not been to any corners so () contains nothing
    ...
    def isGoalState(self, state):
        ...
        # Check if we got to all the corners
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                next_node = (nextx, nexty) # Next node position
                # Check if next_node is visited or not, if not then add it to successorVisited
...
def cornersHeuristic(state, problem):
    ...
    while unvisited:
        closestCorner = state[0] # closestCorner is node or current position
        distance = 100000
        # Find the nearest corner to the Current position and save it to 'distance'
        for corner in unvisited:
            if distance > util.manhattanDistance(node, corner):
                distance = util.manhattanDistance(node, corner)
                closestCorner = corner # Set closestCorner to the nearest corner from current position
        heuristic += distance
        node = closestCorner
